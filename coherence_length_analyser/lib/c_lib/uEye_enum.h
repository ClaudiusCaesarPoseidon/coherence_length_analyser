...
{
    AS_PM_NONE                  = 0,
    AS_PM_SENS_CENTER_WEIGHTED  = 0x00000001, 
    AS_PM_SENS_CENTER_SPOT      = 0x00000002, 
    AS_PM_SENS_PORTRAIT         = 0x00000004, 
	AS_PM_SENS_LANDSCAPE		= 0x00000008  
}AUTO_SHUTTER_PHOTOM;

typedef enum E_AUTO_GAIN_PHOTOM
{
    AG_PM_NONE                  = 0,
    AG_PM_SENS_CENTER_WEIGHTED  = 0x00000001, 
    AG_PM_SENS_CENTER_SPOT      = 0x00000002, 
    AG_PM_SENS_PORTRAIT         = 0x00000004, 
    AG_PM_SENS_LANDSCAPE        = 0x00000008  
}AUTO_GAIN_PHOTOM;
...
typedef enum E_WHITEBALANCE_MODE
{
  ...
  {
      IS_SE_STARTER_FW_UPLOAD =   0x00000001, 
      IS_CP_STARTER_FW_UPLOAD =   0x00000002,
      IS_STARTER_FW_UPLOAD    =   0x00000004  
    ...
    {
        FDT_CAP_INVALID             = 0,
        FDT_CAP_SUPPORTED           = 0x00000001, 
        FDT_CAP_SEARCH_ANGLE        = 0x00000002, 
        FDT_CAP_SEARCH_AOI          = 0x00000004, 
        FDT_CAP_INFO_POSX           = 0x00000010, 
        FDT_CAP_INFO_POSY           = 0x00000020,
        FDT_CAP_INFO_WIDTH          = 0x00000040, 
        FDT_CAP_INFO_HEIGHT         = 0x00000080, 
        FDT_CAP_INFO_ANGLE          = 0x00000100,
        FDT_CAP_INFO_POSTURE        = 0x00000200, 
        FDT_CAP_INFO_FACENUMBER     = 0x00000400,
        FDT_CAP_INFO_OVL            = 0x00000800,
        FDT_CAP_INFO_NUM_OVL        = 0x00001000, 
        FDT_CAP_INFO_OVL_LINEWIDTH  = 0x00002000  
    ...
    {
        FOC_CAP_INVALID             = 0,
        FOC_CAP_AUTOFOCUS_SUPPORTED = 0x00000001,   
        FOC_CAP_MANUAL_SUPPORTED    = 0x00000002,  
        FOC_CAP_GET_DISTANCE        = 0x00000004,  
        FOC_CAP_SET_AUTOFOCUS_RANGE = 0x00000008,
        FOC_CAP_AUTOFOCUS_FDT_AOI   = 0x00000010, 
    ...
    {
        FOC_RANGE_NORMAL            = 0x00000001,   
        FOC_RANGE_ALLRANGE          = 0x00000002,   
        FOC_RANGE_MACRO             = 0x00000004    
    } FOCUS_RANGE;

    typedef enum E_FOCUS_STATUS
    {
        FOC_STATUS_ERROR            = 0x00000001,   
        FOC_STATUS_FOCUSED          = 0x00000002,  
        FOC_STATUS_FOCUSING         = 0x00000004,  
        FOC_STATUS_TIMEOUT          = 0x00000008,  
        FOC_STATUS_CANCEL           = 0x00000010   
    } FOCUS_STATUS;
    ...
    typedef enum E_IMGSTAB_CAPABILITY_FLAGS
    {
        ...
        IMGSTAB_CAP_IMAGE_STABILIZATION_SUPPORTED   = 0x00000001   
